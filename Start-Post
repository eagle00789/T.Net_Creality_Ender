[h1]Creality Ender 3 topic[/h1]

[center][img=500,500]https://i.imgur.com/x2thAQA.png[/img][/center]
[justify]
Er is een heel mooi topic over Open Source 3D printing waar de Ender 3 ook veelvuldig aan bod komt. Ik vond het tijd om, gezien de populairteit van deze printer, een apart topic te maken met wat informatie hier over. Het Open Source 3D printer topic kan je [url=https://gathering.tweakers.net/forum/list_messages/1556417]hier[/url] vinden.
[br]
[h2]Introductie Creality[/h2]
Creality is een Chinees bedrijf uit Shenzen. Ik zal niet diep in gaan op hun geschiedenis, maar dit bedrijf heeft verschillende printers op de markt gebracht met wisselend succes. Zo goed als alle designs zijn gebaseerd op het [url="https://reprap.org/wiki/Prusa_i3"]reprap Prusa i3 design[/url]. 

Creality bestaat al enkele jaren maar heeft zichzelf op de kaart gezet in 2017 met de CR-10 printer. Dit is een 300x300x400mm 3D printer die voor een relatief lage prijs weggezet werd. De print kwaliteit was spectaculair in verhouding tot de prijs en hierdoor is deze printer door zo goed als de hele 3D print community in eind 2017 de hemel in geprezen. Om dit in verhouding te zetten, de Anet A8 was de grootste concurent in dit segment en deze verliest een vergelijking op alle fronten behalve de prijs. Daarnaast is een stock Anet A8 brand gevaarlijk. Helaas waren de eerste CR-10 printers dit ook, maar hier kom ik later op terug.
...
Creality heeft op bepaalde vlakken een goede naam in de community opgebouwd en op bepaalde vlakken wat zaken minder goed aangepakt.
[b]De goede zaken:[/b]
[list]
...
[li]Creality implementeerd aanpassingen in printers zonder de naam of versie van het model te wijzigen dus is het een loterij of je een oud of nieuw model krijgt van dezelfde printer.[/li]
...
Creality heeft in 2018 de Ender 3 op de markt gebracht. Deze printer is als open source printer op de markt gebracht en kan dus door iedereen vrij gemaakt worden. Dit gebeurd dan ook veel en zijn er veel "nep"(?) Ender 3 printers in omloop. "Nep" bedoel ik mee, niet gemaakt door Creality. Zolang de kwaliteit van de onderdelen goed is maakt het weinig uit wie de printer maakt. Alles van de Ender 3 (PCB files, B.O.M. etc.) kun je [url="https://github.com/Creality3DPrinting/Ender-3"]hier[/url] vinden.

De Ender 3 heeft een 24 volt Power Supply aan booard en alle electronische zaken zoals hotend, fans, moederbord, etc. werken dus op 24 volt. Wanneer je wilt upgraden naar een E3D V6 hotend zal je dus een 24 volt versie moeten aanschaffen met 24 volt fan. Ook bijvoorbeeld het vervangen van de fans voor Noctua fans zal je 24 volt fans moeten aanschaffen.
